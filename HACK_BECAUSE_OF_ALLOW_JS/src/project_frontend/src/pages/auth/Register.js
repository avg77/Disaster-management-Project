      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          <div className="form-group">
            ...
            <select id="userType" name="userType" value={formData.userType} onChange={handleChange} className="form-control" required>
          ...
          <div className="form-group">
            ...
            <textarea id="address" name="address" value={formData.address} onChange={handleChange} className="form-control" required/>
          </div>
